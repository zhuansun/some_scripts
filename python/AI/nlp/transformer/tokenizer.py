...
def get_tokenizer(file="/Users/zhuansunpengcheng/workspace/github/some_scripts/python/AI/nlp/transformer/data.txt", saved_dict="/Users/zhuansunpengcheng/workspace/github/some_scripts/python/AI/nlp/transformer/dicts.bin"):
    """
    获取分词器
    """
    # 定义分词器
